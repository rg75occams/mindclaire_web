...
const PressMedia = () => {
    return (
        <>
            <PageTitle title="Mindclaire | Press media" keywords=""
                description="Media coverage and press mentions of Dr. Ritu Goel and MindClaire's innovative approach to mental health, including features in Marquis Who’s Who and Forbes Business Council."
            />
            ...
            <div className="lg:px-[6rem] sm:px-7 px-5 pt-12">
                <div className='container mx-auto'>
                    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-x-8 gap-y-[60px] text-left h-full">
                        {press_media?.map((media, index) => (
                            <div key={index} className='flex flex-col h-full justify-between'>
                                ...
                                <Link to={`/press_media/${media?.id}`} target="_blank" className='mt-4 gap-1
                                    inter_semibold hover:text-[#0a58ca] items-center inter text-[#3c0a6d] flex'
                                >
