            ...
            <div className="lg:px-[6rem] sm:px-7 px-5 pt-12">
                <div className='container mx-auto mt-[70px]'>
                    <h1 className='text-black lg:text-[40px] text-3xl inter_semibold'>
                        PRIVACY POLICY OF MindClaire PC AND Mindclaire.com
                    </h1>
                    ...
                    <p className="text-base lg:mb-4 text-black lg:mt-2 mt-4 inter">
                        MindClaire PC is committed to protecting your privacy online. This Privacy Policy discloses our policies
                        regarding how we collect and process your personal data.
                    </p>

                    <p className="text-base lg:mb-4 text-black lg:mt-2 mt-4 inter">
                        Your use of our website, and any information that you provide to us is subject to this Privacy Policy.
                        This Privacy Policy applies to all site visitors, customers, and all other users of the site.
                    </p>

                    <p className="text-base lg:mb-4 text-black lg:mt-2 mt-4 inter">
                        By accessing our website, you are using it, and acknowledge that you have read this Privacy Policy and
                        consent to be bound by all of its terms, without modification. IF YOU DO NOT AGREE TO BE BOUND BY THIS
                        Privacy Policy, NAVIGATE AWAY FROM THIS WEBSITE.
                    </p>
                    ...
                    <p className="text-base lg:mb-4 text-black lg:mt-2 mt-4 inter">
                        <b>“Website”</b> = mindclaire.com and all content on mindclaire.com and all services offered on
                        mindclaire.com.
                    </p>
                    ...
                    <h2 className='text-black text-3xl inter_medium mt-6'>Personal Information</h2>

                    <p className="text-base lg:mb-4 text-black lg:mt-2 mt-4 inter">
                        Our website offers opportunities for you to voluntarily provide us with your personal information. The
                        term “Personal Information” refers to information which may be used to identify you. Personal Information
                        may include, but is not limited to, your name, email address, phone number, billing address, credit
                        card information, photo, comments, images or videos. If you provide us with your Personal Information,
                        we will collect the information you provide and process it according to this Privacy Policy. You
                        acknowledge and agree that your decision to provide your Personal Information is voluntary and constitutes
                        clear, specific, unambiguous consent for us to collect, process and retain your Personal Information.
                    </p>
                    ...
                    <h2 className='text-black text-3xl inter_medium mt-5'>
                    ...
                    <p className="text-base lg:mb-4 text-black mt-3 inter">
                        3. When you “opt in” to our email list, we will collect your name and email address. We have the right to process this data based on either your clear affirmative consent to be added, or through our legitimate interest in direct marketing to you. If you give consent to “opt in” to our email list, you may withdraw your consent at any time, by following the guidelines in section G. of this Privacy Policy. We may use your data to send you social media marketing or to create lookalike audiences through our social media platforms. In addition, we may use a tracking feature in our emails to collect information about the opening, clicking and forwarding of our emails to refine our future marketing.
                    </p>
                    ...
                    <p className="text-base lg:mb-4 text-black mt-3 inter">
                        Because our core activities do not consist of processing operations which require regular and systematic processing of data subjects on a large scale, nor do we process sensitive data on a large scale, we have determined that MindClaire PC is not required to appoint a Data Protection Officer.
                    </p>
                    ...
                    <p className="text-base lg:mb-4 text-black mt-3 inter">
                        We may include links to external third-party websites on our website. You acknowledge and agree that this Privacy Policy only governs and applies to mindclaire.com and you expressly agree that if you choose to click on any external link, it is entirely at your own risk. You acknowledge and agree that it is your responsibility to review the Privacy Policy of any external websites you visit, even if you were redirected there by clicking on a link located on our website.
                    </p>
